...
public class HarpStageManager : MonoBehaviour
{
    ...
    private IEnumerator CompleteStageRoutine()
    {
        ...
        // Stage'in kendi melody/clip'i (zaten var dedin)
        ...
        // Melody bitene kadar bekle
        yield return new WaitForSeconds(wait);

        // Aynı continue butonunu aç
        ShowContinue();
    }
    ...
    private void OnContinueClicked()
    {
        ...
        // Stage 3 bitti: aynı butonla next scene
        LoadNextScene();
    }
    ...
    private void LoadNextScene()
    {
        ...
        {
            Debug.LogWarning("Son scene! Next yok.");
            return;
        }
